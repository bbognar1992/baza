"""
Project Task model for Pontum Construction Management System
"""
...
class ProjectTask(Base, TimestampMixin):
    ...
    project_task_id = Column(Integer, primary_key=True, autoincrement=True)
    project_phase_id = Column(Integer, ForeignKey('project_phases.project_phase_id', ondelete='CASCADE'), nullable=False)
